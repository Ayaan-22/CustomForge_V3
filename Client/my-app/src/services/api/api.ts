...
export const api = {
  ...
  products: {
    ...
    search: (q: string) =>
      fetch(`${API_URL}/products/search?keyword=${q}`).then(handleResponse),
  ...
  cart: {
    get: () =>
      fetch(`${API_URL}/cart`, { credentials: "include" }).then(handleResponse),
  ...
  orders: {
    getMy: () =>
      fetch(`${API_URL}/orders`, { credentials: "include" }).then(
        handleResponse
      ),
    getById: (id: string) =>
      fetch(`${API_URL}/orders/${id}`, { credentials: "include" }).then(
        handleResponse
      ),
    create: (data: any) =>
  ...
  user: {
    getMe: () =>
      fetch(`${API_URL}/users/me`, { credentials: "include" }).then(
        handleResponse
      ),
    updateMe: (data: any) =>
    ...
    getWishlist: () =>
      fetch(`${API_URL}/users/wishlist`, { credentials: "include" }).then(
        handleResponse
      ),
    getOrders: () =>
      fetch(`${API_URL}/users/orders`, { credentials: "include" }).then(
        handleResponse
      ),
  },
  ...
  admin: {
    getUsers: () =>
      fetch(`${API_URL}/admin/users`, { credentials: "include" }).then(
        handleResponse
      ),
    ...
    getSalesAnalytics: () =>
      fetch(`${API_URL}/admin/analytics/sales`, {
        credentials: "include",
      }).then(handleResponse),
    getProductStats: () =>
